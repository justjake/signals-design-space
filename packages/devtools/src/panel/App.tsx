    ...
    <div className="signals-devtools-root" ref={setRootEl}>
      ...
      <header className="chrome">
        ...
        <span className="histnav" role="group" aria-label="Navigate history">
          <button
            className="theme-btn"
            data-tip="Back to the previous place you looked."
            aria-label="Back"
            disabled={nav.at <= 0}
            onClick={() => go(-1)}
          >
          ...
          <button
            ...
            data-tip="Forward."
            aria-label="Forward"
            disabled={nav.at >= nav.trail.length - 1}
            onClick={() => go(1)}
          >
            ▶
          </button>
        ...
        {onToggleDock ? (
          <button
            className="theme-btn"
            data-tip="Dock the panel to the side or the bottom."
