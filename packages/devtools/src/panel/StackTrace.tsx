...
function injectedProjectRoot(): string {
  const r = (globalThis as { __SIGNALS_DEVTOOLS_PROJECT_ROOT__?: string })
    .__SIGNALS_DEVTOOLS_PROJECT_ROOT__
...
export function StackTrace({ frames }: { frames: StackFrame[] }) {
  ...
  return (
    <div className="cz-section">
      <h3 data-tip="The app stack captured when this operation began — the code that triggered it.">
        Stack
      </h3>
      <ul className="stack">
        {frames.map((f, i) => {
