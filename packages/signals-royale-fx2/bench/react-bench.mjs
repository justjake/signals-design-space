 ...
 *               median ms.
 *
 * Contenders: `royale-fx2` (these bindings) and `uses-baseline` (a minimal
...
const contenders = ['royale-fx2', 'uses-baseline'];
...
const row = (stat, ms) => process.stdout.write(`${scenario},${contender},${stat},${ms.toFixed(3)}\n`);
