 ...
 * lives in cosignal/tests/graph-consumers.spec.ts; the shim rows it cites:
 *
 ...
 *  23     revalidateEffects compares committed-world VALUES, no edge store —
 *         enforced by hooks.spec.tsx useSignalEffect suite.
 */
