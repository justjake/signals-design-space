/**
 * The bare-root page's only script: forward to the default implementation,
 * keeping query and hash (?devtools, ?test=1). Dev and preview serve a 301
 * before this page ever loads (see vite.config.ts); this stub covers static
