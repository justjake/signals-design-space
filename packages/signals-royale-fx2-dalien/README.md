...
The root entry (`signals-royale-fx2-dalien`) is React-free and dependency-free.
React bindings ship as a subpath — `signals-royale-fx2-dalien/react` — with
...
```ts
import { createAtom, createComputed, effect, batch, untracked } from 'signals-royale-fx2-dalien';
...
```ts
import { initializeAtomState, installState, serializeAtomState } from 'signals-royale-fx2-dalien/ssr';
...
# React bindings: `signals-royale-fx2-dalien/react`
