 ...
 * - index.ts (`cosignals`) — the app-author API;
 * - unstable.ts (`cosignals/unstable`) — integration seams, no
 *   compatibility promise;
 * - testing.ts (`cosignals/testing`) — test-only helpers.
 */
 ...
 */
export const SIGNAL_BRAND: unique symbol = Symbol.for('cosignals.signal')
...
export type { ProducerNode, ResolvedState, Suspension, World, DraftId, Draft, UseFn, EqualsFn, Flags }
/**
