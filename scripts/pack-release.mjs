...
try {
  for (const release of plan) {
    ...
    if (sourceManifest.peerDependencies !== undefined)
      manifest.peerDependencies = sourceManifest.peerDependencies
    if (sourceManifest.peerDependenciesMeta !== undefined)
      manifest.peerDependenciesMeta = sourceManifest.peerDependenciesMeta
    await writeFile(
