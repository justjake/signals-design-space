/**
 * VARIANT A — growth support OFF.
 * Fixed giant const buffers at module scope, module-scope functions, no
 * enterDepth tracking, no growPending checks, no maybeBoundary, no mutable
 * engine-ref dispatch. Measures the TOTAL growth-support tax of @lab/arena.
 * Reclamation sweep dropped (probe only; disposal still unlinks correctly).
 */
