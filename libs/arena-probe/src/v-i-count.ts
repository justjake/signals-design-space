...
// ---- instrumentation: propagate/notify memory-op counters ------------------
export const ctr = { visits: 0, flagLoads: 0, flagStores: 0, flagRMWs: 0, linkLoads: 0, nodeLoads: 0, stackPushes: 0, notifies: 0 };
export function resetCtr(): void { for (const k in ctr) (ctr as Record<string, number>)[k] = 0; }
...
function createEngine(
	...
	function propagate(startLink: number, innerWrite: boolean): void {
		...
		top: do {
			...
			ctr.visits++; ctr.linkLoads++; ctr.flagLoads++;
